...
public class FavoriteAdapter extends BaseAdapter {
	...
	public FavoriteAdapter(ArrayList<Document> rowSub, Context ctx) {
		super();
		this.rowSub = rowSub;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Log.e("row","" + getCount());
		ViewHolder holder;
		myInflater = org.holoeverywhere.LayoutInflater.from(ctx, R.style.Holo_Theme_Light);
		
		View rowView;
		if(convertView == null){
			holder = new ViewHolder();
			rowView = myInflater.inflate(R.layout.row_favorite, parent, false);
