...
public class PostAdapter extends BaseAdapter {
	...
	public PostAdapter(Context c, ArrayList<Post> data) {
	...
	public View getView(int pos, View cvView, ViewGroup parrent) {
		...
		if (cvView == null){
			...
			row = inflater.inflate(R.layout.row_post, parrent, false);
		...
		ImageLoader.getInstance().displayImage(HTMLUtil.getFullUrl(post.getAvatarLink()), holder.imgViewAvatar);
		holder.tvContent.setText(post.getContent());
		holder.tvPostTime.setText(DateTimeFormat.format(post.getDateCreate(), DateTimeFormat.SHORT_VALUE));
