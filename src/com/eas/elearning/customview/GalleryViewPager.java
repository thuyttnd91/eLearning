...
/**
 This class implements method to help <b>SmartZoomImageView</b> fling, draggin and scaling.
 */
public class GalleryViewPager extends ViewPager {
    PointF last;
    public ZoomableImageView mCurrentView;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mCurrentView.pagerCanScroll()) {
    		...
    		Log.e("GalleryViewPager", "pointer index out of range");
    	}
