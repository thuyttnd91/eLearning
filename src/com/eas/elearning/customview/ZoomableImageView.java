package com.eas.elearning.customview;
...
//  private static final String TAG = "Touch";
  ...
  static final boolean ZOOMABLE_DEFAULT = true;
  ...
  public void setZoomable(boolean zoomable){
	  if(zoomable) setScaleType(ScaleType.MATRIX);
	  else setScaleType(ScaleType.CENTER);
  }
  ...
  private class Task extends TimerTask {
	...
	static class TimeHandler extends Handler {
	    private final WeakReference<ZoomableImageView> mService; 

	    TimeHandler(ZoomableImageView view) {
	        mService = new WeakReference<ZoomableImageView>(view);
